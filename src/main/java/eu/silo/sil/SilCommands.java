...
public class SilCommands implements CommandMarker { // All command types must implement the CommandMarker interface
    ...
    public void sayHello(
        ...
        @CliOption(key = "dbtype", mandatory = true,  help = "The Database Type") String dbtype             ,
        ...
        operations.createProject(projectname, packagename, dbtype , dbname, dbusername, dbpassword );
    }
